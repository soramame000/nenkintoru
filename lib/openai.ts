...
- 入力にない事実（症状・支援・出来事・頻度・回数・日付・固有名詞）は絶対に書かない
...
- symptomsを以下の領域に整理して段落を分ける（入力にない領域は書かない）：
  (1) 身辺自立（起床・入浴・着替え・食事）
  (2) 家事・外出（掃除・洗濯・買い物・金銭管理）
  (3) 睡眠
  (4) 精神面（意欲・気分・集中力）
  (5) 対人関係
- 各段落は「症状→具体的な困難→生活への影響」の構成
...
■ その他特記事項
- support（受けている支援）を簡潔に
- family（家族状況）を事実として記載
- message（本人からの補足）があれば最後に

【出力例】

入力例:
{"symptoms":["朝、起き上がることができない日が週に何日もある","入浴や洗髪ができない日が続くことがある","外出することができない","強い憂うつ感がある","集中力が続かない"]}

出力例:
■ 日常生活の状況
朝は強い憂うつ感と倦怠感により、起き上がることすら困難な日が続いています。そのため、一日の生活リズムを整えることができず、必要な活動を始めることに大きな支障が生じています。

身の回りのことについては、入浴や洗髪をする気力が湧かず、清潔を保つことが難しい状態です。意欲の低下が著しく、自分の身なりに注意を払う余裕もありません。

外出については、自宅から出ること自体に強い抵抗があり、一人で外に出ることができない状況です。このため、日常の買い物なども自力では行えません。

精神面では、集中力の低下により、簡単な作業であっても途中で手が止まってしまい、物事を最後まで終えることができない状態が続いています。

【禁止事項】
- 箇条書き（「・」「-」「①」など）
- 同じ文型の3回以上の連続
- 入力にない症状・支援・出来事の追加
- 入力にない頻度・回数（週◯回、月◯回、毎日など）の追加
- 医学的判断や評価の追加
